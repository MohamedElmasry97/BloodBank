...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <li><a href="{{url(route('category.index'))}}"><i class="fa fa-list"></i> <span>Categories & posts</span></a></li>
    <li><a href="{{url('donation')}}"><i class="fa fa-heart"></i> <span>Donations</span></a></li>
    <li><a href="{{url('governorate')}}"><i class="fa fa-map-marker"></i> <span>governorate & city</span></a></li>
    ...
    <li><a href="{{url(route('config',1))}}"><i class="fa fa-cogs"></i> <span>config</span></a></li>
    <li><a href="{{url('reset_password')}}"><i class="fa fa-key"></i> <span>Reset password</span></a></li>
    <li><a href="{{url(route('user.index'))}}"><i class="fa fa-users"></i> <span>Users</span></a></li>
    <li><a href="{{url(route('role.index'))}}"><i class="fa fa-list"></i> <span>users permission</span></a></li>
