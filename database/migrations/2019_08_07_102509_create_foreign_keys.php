...
class CreateForeignKeys extends Migration {
	...
	public function up()
	{
		...
		Schema::table('client_government', function(Blueprint $table) {
			$table->foreign('government_id')->references('id')->on('governments')
						->onDelete('cascade')
						->onUpdate('cascade');
		});
	...
	{
		Schema::table('clients', function(Blueprint $table) {
			$table->dropForeign('blood_type_client_id_foreign');
		});
		Schema::table('clients', function(Blueprint $table) {
		...
		Schema::table('donates', function(Blueprint $table) {
			$table->dropForeign('donates_blood_type_id_foreign');
		});
		Schema::table('donates', function(Blueprint $table) {
			$table->dropForeign('donates_client_id_foreign');
		});
		Schema::table('donates', function(Blueprint $table) {
			$table->dropForeign('donates_city_id_foreign');
		});
		Schema::table('cities', function(Blueprint $table) {
			$table->dropForeign('cities_government_id_foreign');
		});
		Schema::table('notifications', function(Blueprint $table) {
			$table->dropForeign('notifications_donate_id_foreign');
		});
		Schema::table('client_post', function(Blueprint $table) {
		...
		Schema::table('client_government', function(Blueprint $table) {
			$table->dropForeign('client_government_government_id_foreign');
		});
		Schema::table('client_government', function(Blueprint $table) {
			$table->dropForeign('client_government_client_id_foreign');
		});
		Schema::table('blood_type_client', function(Blueprint $table) {
